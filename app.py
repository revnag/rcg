...
# Creating Graph conditions 
       if loc!= []:
          ...
          legend=True
          fig=pos_graph(possel,yax,ery,pram,sitel,legend,mycolorVal)
...
def pos_graph(possel,yax,ery,pram,sitel,legend,mycolorVal):
...
# Creating Location map
  ...
  rcgloc.update_traces(textposition='top right',textfont=dict(color='blue',size=10),
                  mode='markers+text',)
